...
/* individual select */
if ($('.radio-list input[type="radio"]').length) {
    $('.select-toggle').fadeOut();
    $('.radio-list input[type="radio"]').click(function () {
        $('.select-toggle').fadeOut();
    });
    $('.radio-list .individual-select input[type="radio"]').click(function () {
        $('.select-toggle').fadeIn();
    });
}
...
$(document).ready(function () {
    ...
    $('#checkAllAuto').on('click', function () {
        $(this).closest('.checker').addClass('focus');
        $(this).closest('#uniform-checkAllAuto > span').addClass('checked');
        $('.subjectid:checkbox').attr('checked', 'checked');
    }, function () {
        $(this).closest('.checker').removeClass('focus');
        $(this).closest('#uniform-checkAllAuto > span').removeClass('checked');
        $('.subjectid:checkbox').removeAttr('checked');
    });
    $("#checkAllAuto").on('click', function () {
        $('#default_controls').toggle();
        $('#bulk_controls').toggle();
        if ($(this).prop('checked') == true) {
            $('#project-list .table-projects .check-box .checker').addClass('focus');
            $('#project-list .table-projects .checker > span').addClass('checked');
            $('#project-list .table-projects tbody > tr').addClass('tr-selected');
        }
        else {
            $('#project-list .table-projects .check-box .checker').removeClass('focus');
            $('#project-list .table-projects .checker > span').removeClass('checked');
            $('#project-list .table-projects tbody > tr').removeClass('tr-selected');
        }
    });
...
jQuery("#file").change(function () {
    ...
    $('.message_img_prev ').html(filename);
});
