            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{Form::open(array('url'=>'/admin/boats/'.$boat->id, 'files'=>true, 'method' => 'PUT','id'=>'exampleSummaryForm','autocomplete'=>'off','class'=>'form-horizontal'))}}
                        ...
                        <div class="form-group form-material <?php if ($errors->first('name') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                       value="{{\Illuminate\Support\Facades\Input::old('name',$boat->name)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('company_name') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="company_name"
                                       value="{{\Illuminate\Support\Facades\Input::old('company_name',$boat->company_name)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('registration_no') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="registration_no" data-plugin="datepicker"
                                       value="{{\Illuminate\Support\Facades\Input::old('registration_no',$boat->registration_no)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('date_of_registration') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="date_of_registration"
                                       ...
                                       value="{{\Illuminate\Support\Facades\Input::old('date_of_registration',$boat->date_of_registration)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('about') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="about"
                                          rows="5">{{\Illuminate\Support\Facades\Input::old('about',$boat->about)}}</textarea>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('habourcraft_number') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="habourcraft_number"
                                       value="{{\Illuminate\Support\Facades\Input::old('habourcraft_number',$boat->habourcraft_number)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('license') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="license"
                                       value="{{\Illuminate\Support\Facades\Input::old('license',$boat->license)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('license_date') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="license_date"
                                       value="{{\Illuminate\Support\Facades\Input::old('license_date',$boat->license_date)}}"/>
                            ...
                            <div class="col-sm-9">
                                <select name="manning_type" class="form-control">
                                    ...
                                    <option value="one manned"
                                            @if(\Illuminate\Support\Facades\Input::old('manning_type',$boat->manning_type)=="one manned") selected @endif>
                                        One Manned
                                    </option>
                                    <option value="two manned"
                                            @if(\Illuminate\Support\Facades\Input::old('manning_type',$boat->manning_type)=="two manned") selected @endif>
                                        Two Manned
                                    </option>
                                </select>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('average_speed') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="average_speed"
                                       value="{{\Illuminate\Support\Facades\Input::old('average_speed',$boat->average_speed)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('capacity') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="capacity"
                                       value="{{\Illuminate\Support\Facades\Input::old('capacity',$boat->capacity)}}"/>
                        ...
                        <div class="form-group form-material <?php if ($errors->first('status') != null) echo "has-error"?>">
                            ...
                            <div class="col-sm-9">
                                <select name="status" class="form-control">
                                    <option value=""
                                            @if(\Illuminate\Support\Facades\Input::old('status',$boat->status)==null) selected @endif>
                                        Please Select One
                                    </option>
                                    <option value="available"
                                            @if(\Illuminate\Support\Facades\Input::old('status',$boat->status)=="available") selected @endif>
                                        Available
                                    </option>
                                    <option value="off-duty"
                                            @if(\Illuminate\Support\Facades\Input::old('status',$boat->status)=="off-duty") selected @endif>
                                        Off-duty
                                    </option>
                                    <option value="busy"
                                            @if(\Illuminate\Support\Facades\Input::old('status',$boat->status)=="busy") selected @endif>
                                        Busy
                                    </option>
                                    <option value="booked"
                                            @if(\Illuminate\Support\Facades\Input::old('status',$boat->status)=="booked")  selected @endif>
                                        Booked
                                    </option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <select name="operating_zone" id="zone" class="form-control">
                                    ...
                                    <option value="Eastern"
                                            @if(\Illuminate\Support\Facades\Input::old('operating_zone',$boat->operating_zone)=="Eastern")  selected @endif>
                                        Western
                                    </option>
                                    <option value="Western"
                                            @if(\Illuminate\Support\Facades\Input::old('operating_zone',$boat->operating_zone)=="Western")  selected @endif>
                                        Eastern
                                    </option>
                                </select>
                                ...
                                <select type="text" name="boat_owner_id" class="form-control">
                                    ...
                                    @foreach($boat_owner_profiles as $boat_owner_profile)
                                        <option value="{{$boat_owner_profile->user_id}}"
                                                @if(\Illuminate\Support\Facades\Input::old('boat_owner_id',$boat->user_id)==$boat_owner_profile->user_id) selected @endif>{{$boat_owner_profile->user->name}}</option>
                                    @endforeach
                                </select>
