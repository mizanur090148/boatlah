...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a class="btn btn-sm btn-primary btn-round" href="{{url('admin/admins/create')}}">
                    ...
                    <div class="widget-header">
                        <div class="widget-header-content">
                            <a class="avatar avatar-lg" href="">
                                @if($admin->thumb_photo!=null)
                                <img src="{{URL::asset($admin->thumb_photo)}}" alt="...">
                                    @else
                                    <img src="{{URL::asset('/images/preview.png')}}" alt="...">
                                @endif
                            </a>
                            <h4 class="profile-user">{{$admin->user->name}}</h4>
                            <p class="profile-job">{{$admin->address}}</p>
                        </div>
                    </div>
                </div>
                <!-- End Page Widget -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <div class="profile-brief">{{$admin->about}}</div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <div class="profile-brief">{{$admin->user->email}}</div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <div class="profile-brief">{{$admin->user->phone}}</div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
