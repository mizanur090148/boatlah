      ...
      <div class="col-md-12">
        ...
        <div class="panel">
          ...
          <div class="panel-body">
            {{Form::open(array('url'=>'/admin/pages', 'files'=>true,'id'=>'exampleSummaryForm','autocomplete'=>'off','class'=>'form-horizontal'))}}

            <div class="form-group form-material <?php if($errors->first('title')!=null) echo "has-error"?>">
              <label class="col-sm-3 control-label">Title</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="title" value="{{\Illuminate\Support\Facades\Input::old('title')}}"/>
            ...
            <div class="form-group form-material <?php if($errors->first('url')!=null) echo "has-error"?>">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="url" value="{{\Illuminate\Support\Facades\Input::old('url')}}"/>
            ...
            <div class="form-group form-material <?php if($errors->first('category')!=null) echo "has-error"?>">
              ...
              <div class="col-sm-9">
                <select name="category" class="form-control">
                  <option value="about" @if(\Illuminate\Support\Facades\Input::old('category')=='about') selected @endif>About</option>
                  <option value="resources" @if(\Illuminate\Support\Facades\Input::old('category')=='resources') selected @endif>Resources</option>
                </select>
            ...
            <div class="form-group form-material <?php if($errors->first('content')!=null) echo "has-error"?>">
              ...
              <div class="col-sm-9">
                <textarea name="content" id="textAreaContent">{{\Illuminate\Support\Facades\Input::old('content')}}</textarea>
