...
@section('content')
  ...
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/admin/admins') }}">All Pages</a></li>
    </ol>
    <div class="page-header-actions">
      <a class="btn btn-sm btn-primary btn-outline" href="{{url('admin/pages/create')}}">
        ...
        <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
          ...
          @foreach($pages as $page)
            <tr>
              ...
              <td class="td-actions"><a href="{{URL::to('admin/pages/'.$page->id)}}" class="btn btn-sm btn-primary btn-outline" ><i class="fa fa-file-text"></i></a>
                <a href="{{URL::to('admin/pages/'.$page->id.'/edit')}}" class="btn btn-sm btn-warning btn-outline"><i class="fa fa-pencil"></i></a>
                {{Form::open(array('url'=>'/admin/pages/'.$page->id, 'method' => 'DELETE','onsubmit'=>'return ConfirmDelete()','id'=>'exampleSummaryForm','autocomplete'=>'off','class'=>'form-horizontal'))}}
