                ...
                <div class="block-wrapper">
                    <div class="block account-block padel-box" style="background:#fff;">
                        <div class="header-bar padel-box-header">
                            <h4 class="clearfix padel-title"><i class="fa fa-group"></i> My Coordinators </h4>
                        </div>
                                ...
                                <div class="col-sm-8 col-sm-offset-2">
                                    <form class="form-horizontal form-edit-profile" method="POST" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group <?php if($errors->first('username')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="userName" name="username" value="{{\Illuminate\Support\Facades\Input::old('username',$coordinator->user->username)}}" placeholder=""/>
                                        ...
                                        <div class="form-group <?php if($errors->first('name')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="name" value="{{ \Illuminate\Support\Facades\Input::old('name',$coordinator->user->name) }}" placeholder="">
                                        ...
                                        <div class="form-group <?php if($errors->first('email')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="email" value="{{\Illuminate\Support\Facades\Input::old('email', $coordinator->user->email) }}" placeholder="">
                                        ...
                                        <div class="form-group <?php if($errors->first('phone')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="phone" value="{{\Illuminate\Support\Facades\Input::old('phone',$coordinator->user->phone) }}" placeholder="">
                                        ...
                                        <div class="form-group  <?php if($errors->first('gender')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="gender" class="form-control">
                                                    ...
                                                    <option value="male" @if(\Illuminate\Support\Facades\Input::old('gender',$coordinator->gender)=='male') selected @endif>Male</option>
                                                    <option value="female" @if(\Illuminate\Support\Facades\Input::old('gender',$coordinator->gender)=='female') selected @endif>Female</option>
                                                </select>
                                        ...
                                        <div class="form-group <?php if($errors->first('location')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="location" class="form-control">
                                                    <option value="">Select One</option>
                                                    <option value="Western" @if(\Illuminate\Support\Facades\Input::old('location',$coordinator->location)=='Western') selected @endif>Western</option>
                                                    <option value="Eastern" @if(\Illuminate\Support\Facades\Input::old('location',$coordinator->location)=='Eastern') selected @endif>Eastern</option>
                                                </select>
                                        ...
                                        <div class="form-group <?php if($errors->first('address')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="address" value="{{\Illuminate\Support\Facades\Input::old('address',$coordinator->user->address)}}"/>
                                        ...
                                        <div class="form-group <?php if($errors->first('about')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="about" placeholder="">{{\Illuminate\Support\Facades\Input::old('about', $coordinator->about) }}</textarea>
                                        ...
                                        <div class="form-group form-material <?php if($errors->first('photo')!=null) echo "has-error"?>">
                                          <label class="col-sm-3 control-label">Image</label>
                                            <img src="{{URL::asset($coordinator->user->thumb_photo)}}" class="col-sm-3" style="height: 25%;width: 25%">
                                            <div class="col-sm-6">
