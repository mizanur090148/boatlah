                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><div class="calog-alist">
                                                                                <a href="{{ url('/coordinator/dashboard/catalogs/'.$boat->manning_type.'/one way/'.$boat->operating_zone.'/'.$boat->user_id) }}" @if($one_way==null) class="inactive" @else class="active" @endif> One Way</a>
                                                                                <a href="{{ url('/coordinator/dashboard/catalogs/'.$boat->manning_type.'/returning/'.$boat->operating_zone.'/'.$boat->user_id) }}" @if($returning==null) class="inactive" @else class="active" @endif> Returning</a>
                                                                            </div> 
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td><div class="calog-alist">
                                                                                    <a href="{{ url('/coordinator/dashboard/catalogs/'.$boat->manning_type.'/one way/'.$boat->operating_zone.'/'.$boat->user_id.'/'.$company->company_id) }}" class="{{ $one_way1->status }}"> One Way </a>
                                                                                    <a href="{{ url('/coordinator/dashboard/catalogs/'.$boat->manning_type.'/returning/'.$boat->operating_zone.'/'.$boat->user_id.'/'.$company->company_id) }}" class="{{ $returning1->status }}"> Returning </a>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
