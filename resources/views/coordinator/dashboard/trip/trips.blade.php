                    ...
                    <div class="block-wrapper">
                        <div class="block account-block padel-box" style="background:#fff;">
                            <div class="header-bar padel-box-header">
                                <h4 class="clearfix padel-title"><i class="fa fa-ship"></i> Trips
                                </h4>
                            </div>
                            <div class="padel-box-body">

                            {{Form::open(array('url'=>'/coordinator/dashboard/trips_post', 'files'=>true,'class'=>'form-horizontal'))}}
                                <table class="table table-report-date">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-info btn-block">Show Trips</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
