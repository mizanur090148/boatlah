                    ...
                    <div class="block account-block padel-box" style="background:#fff;">
                        <div class="header-bar padel-box-header">
                            <h4 class="clearfix padel-title"><i class="fa fa-user"></i> Profile 
                                <a href="/user/dashboard/profile/edit" class="pull-right rb-edit"><i class="fa fa-pencil"></i>Edit</a>
                            </h4>
                        </div>
                            ...
                            <div class="profile-heading clearfix">
                                <div class="profile-avater">
                                    @if($user_info->user->thumb_photo!=null)
                                        <img class="pavater" src="{{URL::asset($user_info->user->thumb_photo)}}" alt="...">
                                    @else
                                        <img class="pavater" src="{{URL::asset('/images/preview.png')}}" alt="...">
                                    @endif
                                </div>
                                <div class="profile-denote">
                                    <h3 class="pro-name"><a href="/user/dashboard">{{$user_info->user->name}}</a></h3>
                                    <p>
                                       {{$user_info->about}}
                                    </p>
                                </div> 
