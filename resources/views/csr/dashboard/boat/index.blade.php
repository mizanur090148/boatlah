                ...
                <div class="block-wrapper">
                    <div class="block account-block padel-box" style="background:#fff;">
                        <div class="header-bar padel-box-header">
                            <h4 class="clearfix padel-title"><i class="fa fa-ship"></i> Boats Available for Book Now</h4>
                        </div>
                                ...
                                @foreach($boats as $boat)
                                    <div class="single-boat dtable">
                                        ...
                                        <div class="cell content">
                                            ...
                                            <!-- boat-info -->
                                            <div class="boat-meta">
                                                <a class="btn btn-info btn-sm" href="{{url('/csr/dashboard/catalogs/'.$boat->id)}}"><i class="fa fa-usd"></i> Show Catalog</a>
                                                @if($boat->status=='available' && $boat->captain!=null)
                                                    <a class="btn btn-success btn-sm" href="{{url('/csr/dashboard/book/'.$user_id.'/'.$boat->id)}}"><i class="fa fa-ticket"></i> Book This Boat</a>
                                                @endif
                                            </div>
                                        </div>
                                        <!-- content -->
