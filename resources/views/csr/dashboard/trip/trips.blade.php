                    ...
                    <div class="block-wrapper">
                        <div class="block account-block padel-box padel-trip" style="background:#fff;">
                            <div class="header-bar padel-box-header">
                                <h4 class="clearfix padel-title"><i class="fa fa-ship"></i>All Trips </h4>
                            </div>
                                ...
                                <div role="tabpanel">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ongoing">
                                            <table class="display table dtable-default table-xpadd" id="myCompany2">
                                                <thead>
                                                <tr>
                                                    <th>Trip ID</th>
                                                    <th>Boat</th>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="complete">
                                            <table class="display table dtable-default table-xpadd" id="myCompany3">
                                                <thead>
                                                <tr>
                                                    <th>Trip ID</th>
                                                    <th>Boat</th>
                                                ...
                                                @foreach($trips as $trip)
                                                    @if($trip->status=='completed')
                                                        <tr>
                                                            ...
                                                            <td>{{$trip->destination->title}}</td>
                                                            <td>{{$trip->cost}} SGD</td>
                                                            <td><a href="{{url('/user/dashboard/trip_invoice/download/'.$trip->id)}}">Download Invoice</a></td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                                                </tbody>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#myCompany').DataTable();
            $('#myCompany2').DataTable();
            $('#myCompany3').DataTable();
