                    ...
                    <div class="block-wrapper">
                        <div class="block account-block padel-box" style="background:#fff;">
                            <div class="header-bar padel-box-header">
                                <h4 class="clearfix padel-title"><i class="fa fa-group"></i> Employees                                    
                                    <a href="/company/dashboard/connect_employee" class="pull-right rb-edit"><i class="fa fa-plus"></i>Add New Employee</a>
                                </h4>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="company-binfo">
                                                    <div class="com-thumb">
                                                        <img class="img-responsive" src="{{$employee->user->photo}}" alt="img">
                                                    </div>
                                                    <div class="com-note">
                                                        <h4><a href="">{{$employee->user->name}}</a></h4>
                                                        <p>
                                                            {{$employee->about}}
                                                        </p>                                                       
                                                    </div>
                                            ...
                                            <td>
                                                {{Form::open(array('url'=>'/company/dashboard/my_employee/delete/'.$employee->id,'method' => 'POST','id'=>'exampleSummaryForm','autocomplete'=>'off','class'=>'form-horizontal','enctype'=>'multipart/form-data'))}}
