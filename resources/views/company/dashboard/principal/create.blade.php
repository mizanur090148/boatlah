                            ...
                            <div class="padel-box-body">
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        {{Form::open(array('url'=>'/company/dashboard/my_principals','method' => 'POST','id'=>'exampleSummaryForm','autocomplete'=>'off','class'=>'form-horizontal','enctype'=>'multipart/form-data'))}}
                                        ...
                                        <div class="form-group form-material <?php if($errors->first('principle_name')!=null) echo "has-error"?>">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="principle_name" value="{{ \Illuminate\Support\Facades\Input::old('principle_name')}}">
